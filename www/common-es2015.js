...
let GeneralService = class GeneralService {
    constructor(alertController, loadingController, toastController) {
...
/* harmony import */ var _general_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./general.service */ "./src/app/providers/general.service.ts");
/* harmony import */ var _globaldata_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./globaldata.service */ "./src/app/providers/globaldata.service.ts");
...
let HttpService = class HttpService {
    constructor(http, general, router) {
        this.http = http;
    ...
    getApi(link, loader) {
        ...
        return new Promise((resolve) => {
            this.http.get(this.globalUrl + link, { headers: this.headers }).subscribe((data) => {
                resolve(data);
                this.general.stopLoading();
            }, (error) => {
                console.log("Error" + error);
    ...
    getFlag(link, loader) {
        ...
        return new Promise((resolve) => {
            this.http.get(link, { headers: this.headers }).subscribe((data) => {
                resolve(data);
                this.general.stopLoading();
            }, (error) => {
                this.general.stopLoading();
