...
let FeedComponent = class FeedComponent {
    ...
    getfeeds() {
        this.http.getApi(this.http.api.feeds, true).then((res) => {
            console.log(res);
            this.feeds = res;
        });
    }
...
FeedComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-feed",
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./feed.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/feed/feed.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./feed.component.scss */ "./src/app/components/feed/feed.component.scss")).default]
    }),
